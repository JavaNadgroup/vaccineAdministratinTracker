<%-- 
    ...
    Created on : Dec 4, 2021, 9:01:39 AM
    Author     : ogrey
--%>
...
<%@taglib uri="/WEB-INF/tlds/target.tld" prefix="target" %>
<!DOCTYPE html>.
                ...
                <div class="w-full md:w-1/2 xl:w-1/3 p-6">
                    <div class="bg-gradient-to-b from-blue-200 to-blue-100 border-b-4 border-blue-500 rounded-lg shadow-xl p-5">
                        <div class="flex flex-row items-center">
                            ...
                            <div class="flex-1 text-right md:text-center">
                                <h5 class="font-bold uppercase text-gray-600">Remaining Vaccinations to hit the Target</h5>
                                <h3 class="font-bold text-3xl"><target:select table="patients"/></h3>
                            </div>
                        </div>
                    </div>
                </div>
