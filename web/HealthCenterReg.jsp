<%-- 
    Document   : HealthCenterReg
    Created on : Dec 4, 2021, 4:00:47 PM
    Author     : ogrey
--%>
...
<html>
    ...
    <link href="tailwind.css" rel="stylesheet"> <!--Replace with your tailwind.css once created-->
    ...
    <nav class="bg-gray-800 pt-2 md:pt-1 pb-1 px-1 mt-0 h-auto fixed w-full z-20 top-0">
        ...
        <div class="flex flex-wrap items-center">
            ...
            <div class="flex flex-1 md:w-1/3 justify-center md:justify-start text-white px-2">
                <h2 class="text-2xl font-bold text-white text-rights">Health Center Page</h2>
            </div>
        ...
        <div class="bg-gray-800 shadow-xl h-16 fixed bottom-0 mt-12 md:relative md:h-screen z-10 w-full md:w-48">
            ...
            <div class="md:mt-12 md:w-48 md:fixed md:left-0 md:top-0 content-center md:content-start text-left justify-between">
                <ul class="list-reset flex flex-row md:flex-col py-0 md:py-3 px-1 md:px-2 text-center md:text-left">
                    ...
                    <li class="mr-3 flex-1">
                        <a href="AddHealthCenter.jsp" class="block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-gray-800 hover:border-pink-500">
                            <i class="fas fa-tasks pr-0 md:pr-3"></i><span class="pb-1 md:pb-0 text-xs md:text-base text-gray-600 md:text-gray-400 block md:inline-block">Add Health Center</span>
                        </a>
                    </li>
                    <li class="mr-3 flex-1">
                        <a href="PatientRegForm.jsp" class="block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-gray-800 hover:border-purple-500">
                            <i class="fa fa-envelope pr-0 md:pr-3"></i><span class="pb-1 md:pb-0 text-xs md:text-base text-gray-600 md:text-gray-400 block md:inline-block">Register Patient</span>
                        </a>
                    </li>
                    <li class="mr-3 flex-1">
        ...
        <div class="main-content flex-1 bg-gray-100 mt-12 md:mt-2 pb-24 md:pb-5">
            ...
            <div class="bg-gray-800 pt-3">
                <div class="rounded-tl-3xl bg-gradient-to-r from-blue-900 to-gray-800 p-4 shadow text-2xl text-white">
                    <h3 class="font-bold pl-2">Health Center Information</h3>
                </div>
            </div>

            <div class="flex flex-wrap">
                <!-- hospital registration form goes here -->
            </div>
        </div>
    </div>
